...
def generate_launch_description():
    ...
    # Setup project paths
    pkg_project_bringup = get_package_share_directory('robotl_bringup')
    pkg_project_description = get_package_share_directory('robotl_description')
    ...
    rviz = Node(
       package='rviz2',
       executable='rviz2',
       arguments=['-d', os.path.join(pkg_project_bringup, 'config', 'diff_drive.cfg')],
